...
<template>
  <template v-if="data.directPress">
    ...
    <text :x="x + sl * 0.65" :y="y + sh * 0.9" font-family="Arial" :font-size="r * 1.7" fill="black" text-anchor="middle">
    ...
    <template v-if="data.directPress === '011'">
      ...
      <path
        :d="`M${x + (1 - 0.46) * sl + sl / 4} ${y + sh / 2 + sh / 4} v${sh / 8} h${sh / 3} v${-sh / 2 + sh / 8}`"
        stroke="black"
        stroke-width="2"
        fill="none"
      />
    ...
    <template v-if="data.directPress === '012'">
      ...
      <path
        :d="`M${x + 0.46 * sl} ${y + sh / 2} h${-sh} v${-sh / 2 + sh / 8} h${sh + (1 - 0.46) * sl}`"
        stroke="black"
        stroke-width="2"
        fill="none"
      />
      <path
        :d="`M${x + sh / 2 + sh / 4} ${y + sh / 2 + sh / 4} v${sh / 8} h${-sh / 3} v${-sh / 2 + sh / 8}`"
        stroke="black"
        stroke-width="2"
        fill="none"
      />
    ...
    <template v-if="data.directPress === '015'">
      ...
      <path
        :d="`M${x + 0.46 * sl} ${y + sh / 2} h${-sh} v${-sh / 2 + sh / 12} h${sh + (1 - 0.46) * sl - 0.46 * sl}`"
        stroke="black"
        stroke-width="2"
        fill="none"
      />
