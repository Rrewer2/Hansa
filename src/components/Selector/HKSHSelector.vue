...
<template>
  <article class="art grid">
    <div>
      ...
      Dławnica
      <div class="container">
        <img :src="links.HKCG" alt="HKCG" class="imgLogo" key="HKCG" :class="{ active: dlawType.value === 'HKCG' }" @click="dlawType.value = 'HKCG'"/>
        <img :src="links.HKCGPM" alt="HKCGPM" class="imgLogo" key="HKCGPM" :class="{ active: dlawType.value === 'HKCGPM' }" @click="dlawType.value = 'HKCGPM'"/>
      </div>
