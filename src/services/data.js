...
export const enginesData = [...enginesK400, ...enginesK230, ...enginesT3A, ...enginesHK, ...enginesACMotoren].map(({ meta, title, size, ...rest }) => ({
  title,
  size,
  ...rest,
  meta,
  mount: meta.match(/B14|B34|B35|B5/)?.[0] || title.match(/B14|B34|B35|B5/)?.[0] || "B35",
  shaft: motorShaft[size],
}));
...
export const coolerData = [
  { title: "2005K", flow: { min: 5, max: 75 }, performance: { min: 0.021, max: 0.031 }, join: "G1/2″ -14" },
  { title: "2010K", flow: { min: 20, max: 100 }, performance: { min: 0.052, max: 0.06 }, join: "G1/2″ -14" },
  // {title: "2015K", flow: {min: 20, max: 200}, performance: {min: 0.084, max: 0.101},},
  { title: "2020K", flow: { min: 20, max: 250 }, performance: { min: 0.099, max: 0.12 }, join: "G1″ -11" },
  { title: "2024K", flow: { min: 20, max: 250 }, performance: { min: 0.165, max: 0.214 }, join: "G1″ -11" },
  // {title: "2030K", flow: {min: 50, max: 300}, performance: {min: 0.257, max: 0.309},},
  { title: "2040K", flow: { min: 50, max: 350 }, performance: { min: 0.337, max: 0.425 }, join: "G1.1/4″ -11" },
  // {title: "2050K", flow: {min: 50, max: 400}, performance: {min: 0.447, max: 0.635}},
  { title: "HPA30", flow: { min: 40, max: 160 }, performance: { min: 0.5, max: 0.77 }, join: "G1.1/4″ -11" },
  { title: "HPA36", flow: { min: 40, max: 200 }, performance: { min: 0.7, max: 1.1 }, join: "G1.1/4″ -11" },
  { title: "HPA52", flow: { min: 80, max: 280 }, performance: { min: 1.1, max: 1.55 }, join: "G1.1/2″ -11" },
...
export const ventilation = [
  ...
  { title: "FIBL080GP03", thread: "G3/4″ -14", q: 450 },
  { title: "FIBL080GP10", thread: "G3/4″ -14", q: 550 },
...
export const HKRTR = [{ title: "HKRTR0502CG1P10", join: "G3/8″ -19", q: 25, type: "PowerPack", filterGrade: "P10" }];
const FIRL = [
  { title: "FIRL024A10NVG1/2", join: "G1/2″ -14", q: 24, hole: 66 },
  { title: "FIRL048P10NVG1/2", join: "G1/2″ -14", q: 60, hole: 66 },
  { title: "FIRL053A10NVG1/2", join: "G1/2″ -14", q: 53, hole: 88 },
  { title: "FIRL064A10NVG3/4", join: "G3/4″ -14", q: 64, hole: 88 },
  { title: "FIRL086P10NVG3/4", join: "G3/4″ -14", q: 86, hole: 88 },
  { title: "FIRL110P10NVG1/2", join: "G1/2″ -14", q: 86, hole: 88 },
  { title: "FIRL110P10NVG3/4", join: "G3/4″ -14", q: 110, hole: 88 },
  { title: "FIRL150P10NVG1", join: "G1″ -11", q: 110, hole: 88 },
  { title: "FIRL150P10NVG3/4", join: "G3/4″ -14", q: 110, hole: 88 },
  { title: "FIRL225P10NVG1", join: "G1″ -11", q: 220, hole: 88 },
  { title: "FIRL225P10NVG3/4", join: "G3/4″ -14", q: 220, hole: 88 },
  { title: "FIRL281P10NVG11/4", join: "G1.1/4″ -11", q: 280, hole: 129.5 },
  { title: "FIRL290A10NVG11/4", join: "G1.1/4″ -11", q: 290, hole: 173.5 },
  { title: "FIRL370P10NVG11/2", join: "G1.1/2″ -11", q: 610, hole: 173.5 },
  { title: "FIRL610P10NVG11/2", join: "G1.1/2″ -11", q: 610, hole: 173.5 },
].map((el) => ({ ...el, type: "In-Tank", filterGrade: el.title.match(/(A10|P10)/)?.[0], addition: { clogging: { title: "HKVAVR" } } }));
const FISPR = [
  { title: "FISPR48A10VG3/4", join: "G3/4″ -14", q: 48 },
  { title: "FISPR55P10VG3/4", join: "G3/4″ -14", q: 55 },
  { title: "FISPR110A10VG11/4", join: "G1.1/4″ -11", q: 110 },
  { title: "FISPR115A10VG11/4", join: "G1.1/4″ -11", q: 115 },
  { title: "FISPR150P10VG11/4", join: "G1.1/4″ -11", q: 150 },
  { title: "FISPR220A10VG11/2", join: "G1.1/2″ -11", q: 220 },
  { title: "FISPR250A10VG11/2", join: "G1.1/2″ -11", q: 250 },
  { title: "FISPR282P10VG11/2", join: "G1.1/2″ -11", q: 282 },
...
export const flanges = [
  { title: "WDA0.538", pressure: 180, LK: "Ø26mm / M5", thread: "G3/8″ -19", QS: 7, QP: 20 },
  { title: "WDA0.512", pressure: 180, LK: "Ø26mm / M5", thread: "G1/2″ -14", QS: 16, QP: 35 },
  // {title: "WDA138", pressure: 180, LK: "Ø30mm / M6", thread: "G3/8″ -19", QS: 7, QP: 20},
  { title: "WDA112", pressure: 180, LK: "Ø30mm / M6", thread: "G1/2″ -14", QS: 20, QP: 40 },
  { title: "WDA212", pressure: 180, LK: "Ø40mm / M8", thread: "G1/2″ -14", QS: 12, QP: 35 },
  { title: "WDA234", pressure: 180, LK: "Ø40mm / M8", thread: "G3/4″ -14", QS: 35, QP: 75 },
  { title: "WDA334", pressure: 180, LK: "Ø51mm / M10", thread: "G3/4″ -14", QS: 25, QP: 75 },
  { title: "WDA3100", pressure: 180, LK: "Ø56mm / M10", thread: "G1″ -11", QS: 43, QP: 120 },
  { title: "WDS0.538", pressure: 315, LK: "Ø26mm / M5", thread: "G3/8″ -19", QS: 7, QP: 20 },
  { title: "WDS0.512", pressure: 315, LK: "Ø26mm / M5", thread: "G1/2″ -14", QS: 16, QP: 35 },
  // {title: "WDS138", pressure: 315, LK: "Ø30mm / M6", thread: "G3/8″ -19", QS: 7, QP: 20},
  { title: "WDS112", pressure: 315, LK: "Ø30mm / M6", thread: "G1/2″ -14", QS: 20, QP: 40 },
  { title: "WDS212", pressure: 315, LK: "Ø40mm / M8", thread: "G1/2″ -14", QS: 12, QP: 35 },
  { title: "WDS234", pressure: 315, LK: "Ø40mm / M8", thread: "G3/4″ -14", QS: 35, QP: 75 },
  { title: "WDS334", pressure: 315, LK: "Ø51mm / M10", thread: "G3/4″ -14", QS: 25, QP: 75 },
  { title: "WDS3100", pressure: 315, LK: "Ø51mm / M10", thread: "G1″ -11", QS: 43, QP: 120 },
  { title: "WDS3B34", pressure: 315, LK: "Ø56mm / M10", thread: "G3/4″ -14", QS: 25, QP: 75 },
  { title: "WDS3B100", pressure: 315, LK: "Ø56mm / M10", thread: "G1″ -11", QS: 43, QP: 120 },
  { title: "F1", pressure: 250, LK: "Ø30mm / M6", thread: "G3/8″ -19", QS: 7, QP: 20 },
  { title: "F2", pressure: 250, LK: "Ø40mm / M8", thread: "G1/2″ -14", QS: 12, QP: 35 },
  { title: "F3A", pressure: 250, LK: "Ø51mm / M10", thread: "G3/4″ -14", QS: 25, QP: 75 },
  { title: "F3B", pressure: 250, LK: "Ø56mm / M10", thread: "G3/4″ -14", QS: 25, QP: 75 },
  { title: "F3.5A", pressure: 180, LK: "Ø62mm / M10", thread: "G1″ -11", QS: 43, QP: 120 },
  { title: "F3.5B", pressure: 180, LK: "Ø62mm / M12", thread: "G1″ -11", QS: 43, QP: 120 },
  { title: "F4", pressure: 180, LK: "Ø72.5mm / M12", thread: "G1.1/4″ -11", QS: 70, QP: 200 },
...
const gearPumpAPF = [
  {},
  {
    HK1PF21L01Z01LBF: { CC: 2.1, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 200, holePattern: "40 x 40 - Ø32" },
    HK1PF27L01Z01LBF: { CC: 2.7, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 200, holePattern: "40 x 40 - Ø32" },
    HK1PF37L01Z01LBF: { CC: 3.7, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 200, holePattern: "40 x 40 - Ø32" },
    HK1PF42L01Z01LBF: { CC: 4.2, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 200, holePattern: "40 x 40 - Ø32" },
    HK1PF58L01Z01LBF: { CC: 5.8, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 160, holePattern: "40 x 40 - Ø32" },
    HK1PF80L01Z01LBF: { CC: 8, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 160, holePattern: "40 x 40 - Ø32" },
  },
  {
...
const gearPumpVivolo = [
  {
    HK0P0102ABBA: { CC: 0.16, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
    HK0P0202ABBA: { CC: 0.24, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
    HK0P0402ABBA: { CC: 0.45, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
    HK0P0502ABBA: { CC: 0.56, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
    HK0P0602ABBA: { CC: 0.75, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
    HK0P0702ABBA: { CC: 0.92, in: "G1/4″ -19", out: "G1/4″ -19", shaft: "Ø7", pmax: 220, holePattern: "Ø66 - Ø22" },
  },
  {
    ...
    HK1P1602FBBA: { CC: 0.91, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 240, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P1702FBBA: { CC: 1.17, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 250, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P1802FBBA: { CC: 1.56, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 250, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2002FBBA: { CC: 2.08, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 250, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2102FBBA: { CC: 2.6, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 250, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2302FBBA: { CC: 3.12, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 240, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2502FBBA: { CC: 3.64, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 240, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2702FBBA: { CC: 4.16, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 240, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P2902FBBA: { CC: 4.94, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 200, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P3102FBBA: { CC: 5.85, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 190, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P3202FBBA: { CC: 6.5, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 190, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P3402FBBA: { CC: 7.54, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 190, holePattern: "71.9 x 52.4 - Ø25.4" },
    HK1P3602FBBA: { CC: 9.88, in: "G3/8″ -19", out: "G3/8″ -19", shaft: "1: 8", pmax: 170, holePattern: "71.9 x 52.4 - Ø25.4" },
  ...
  {
    HK2P4102EOOA: { CC: 4.2, in: "Ø30mm / M6", out: "Ø30mm / M6", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4302EOOA: { CC: 6, in: "Ø30mm / M6", out: "Ø30mm / M6", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4502EOOA: { CC: 8.4, in: "Ø30mm / M6", out: "Ø30mm / M6", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4702EOOA: { CC: 10.8, in: "Ø30mm / M6", out: "Ø30mm / M6", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4902EPOA: { CC: 14.4, in: "Ø40mm / M8", out: "Ø30mm / M6", shaft: "1: 8", pmax: 250, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5102EPOA: { CC: 16.8, in: "Ø40mm / M8", out: "Ø30mm / M6", shaft: "1: 8", pmax: 230, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5302EPOA: { CC: 19.2, in: "Ø40mm / M8", out: "Ø30mm / M6", shaft: "1: 8", pmax: 210, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5502EPOA: { CC: 22.8, in: "Ø40mm / M8", out: "Ø30mm / M6", shaft: "1: 8", pmax: 200, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5702EQPA: { CC: 26.2, in: "Ø40mm / M8", out: "Ø40mm / M8", shaft: "1: 8", pmax: 170, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P6102EQPA: { CC: 30, in: "Ø40mm / M8", out: "Ø40mm / M8", shaft: "1: 8", pmax: 160, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5902EQPA: { CC: 34.2, in: "Ø40mm / M8", out: "Ø40mm / M8", shaft: "1: 8", pmax: 150, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P6302EQPA: { CC: 39.6, in: "Ø40mm / M8", out: "Ø40mm / M8", shaft: "1: 8", pmax: 140, holePattern: "96.2 x 71.5 - Ø36.5" },

    HK2P4102EBBA: { CC: 4.2, in: "G1/2″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4302EBBA: { CC: 6, in: "G1/2″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4502EBBA: { CC: 8.4, in: "G1/2″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4702EBBA: { CC: 10.8, in: "G1/2″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 260, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P4902ECBA: { CC: 14.4, in: "G3/4″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 250, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5102ECBA: { CC: 16.8, in: "G3/4″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 230, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5302ECBA: { CC: 19.2, in: "G3/4″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 210, holePattern: "96.2 x 71.5 - Ø36.5" },
    HK2P5502ECBA: { CC: 22.8, in: "G3/4″ -14", out: "G1/2″ -14", shaft: "1: 8", pmax: 200, holePattern: "96.2 x 71.5 - Ø36.5" },

    HK2P4142FSRA: { CC: 4.2, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 260, holePattern: "100 x 72 - Ø80" },
    HK2P4342FSRA: { CC: 6, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 260, holePattern: "100 x 72 - Ø80" },
    HK2P4542FSRA: { CC: 8.4, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 260, holePattern: "100 x 72 - Ø80" },
    HK2P4742FSRA: { CC: 10.8, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 260, holePattern: "100 x 72 - Ø80" },
    HK2P4942FSRA: { CC: 14.4, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 250, holePattern: "100 x 72 - Ø80" },
    HK2P5142FSRA: { CC: 16.8, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 230, holePattern: "100 x 72 - Ø80" },
    HK2P5342FSRA: { CC: 19.2, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 210, holePattern: "100 x 72 - Ø80" },
    HK2P5542FSRA: { CC: 22.8, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 200, holePattern: "100 x 72 - Ø80" },
    HK2P5742FSRA: { CC: 26.2, in: "Ø40mm / M8", out: "Ø35mm / M6", shaft: "1: 5", pmax: 170, holePattern: "100 x 72 - Ø80" },
  },
  {
...
const gearPumpRexroth = [
  {
    HKKM1: { CC: 0.17, in: "G1/4″ -19", out: "Bore Ø5 mm with O-Ring", shaft: "Ø7,16 frez 5", pmax: 220, holePattern: "Ø66 - Ø22" },
    HKK01: { CC: 0.25, in: "G1/4″ -19", out: "Bore Ø5 mm with O-Ring", shaft: "Ø7,16 frez 5", pmax: 220, holePattern: "Ø66 - Ø22" },
    HKK02: { CC: 0.45, in: "G1/4″ -19", out: "Bore Ø5 mm with O-Ring", shaft: "Ø7,16 frez 5", pmax: 220, holePattern: "Ø66 - Ø22" },
    HKK03: { CC: 0.57, in: "G1/4″ -19", out: "Bore Ø5 mm with O-Ring", shaft: "Ø7,16 frez 5", pmax: 220, holePattern: "Ø66 - Ø22" },
    HKK04: { CC: 0.76, in: "G1/4″ -19", out: "Bore Ø5 mm with O-Ring", shaft: "Ø7,16 frez 5", pmax: 220, holePattern: "Ø66 - Ø22" },
  },
  {
    HKK10: { CC: 0.92, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK11: { CC: 1.17, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK12: { CC: 1.56, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK13: { CC: 2.08, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK14: { CC: 2.6, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK15: { CC: 3.12, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK16: { CC: 3.64, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 200, holePattern: "40 x 40 - Ø32" },
    HKK17: { CC: 4.16, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 180, holePattern: "40 x 40 - Ø32" },
    HKK18: { CC: 4.94, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 150, holePattern: "40 x 40 - Ø32" },
    HKK19: { CC: 5.85, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "Ø10 frez 5", pmax: 120, holePattern: "40 x 40 - Ø32" },
    HKK10CON: { CC: 0.92, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK11CON: { CC: 1.17, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK12CON: { CC: 1.56, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK13CON: { CC: 2.08, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK14CON: { CC: 2.6, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK15CON: { CC: 3.12, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK16CON: { CC: 3.64, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK17CON: { CC: 4.16, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK18CON: { CC: 4.94, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK19CON: { CC: 5.85, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK19ACON: { CC: 6.5, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 220, holePattern: "40 x 40 - Ø32" },
    HKK20CON: { CC: 7.54, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 210, holePattern: "40 x 40 - Ø32" },
    HKK21CON: { CC: 9.88, in: "G3/8″ -19", out: "Bore Ø9.25mm with O-Ring", shaft: "1: 8", pmax: 190, holePattern: "40 x 40 - Ø32" },
  },
  {},
  {},
];
...
const pistonPumpKawasaki = {
  HKK3VL045B1NRMMP0: { CC: 45, in: "SAE J518C - 1.1/2″", out: "SAE J518C - 1″", drain: "M22 x 1.5", pmax: 320, regulator: "Regulator ciśnienia", holePattern: "Ø140 - Ø100 ISO 3019/2", shaft: "Ø25" },
  HKK3VL080B1NRMMP0: { CC: 80, in: "SAE J518C - 2″", out: "SAE J518C - 1″", drain: "M22 x 1.5", pmax: 320, regulator: "Regulator ciśnienia", holePattern: "Ø180 - Ø125 ISO 3019/2", shaft: "Ø32" },
  HKK3VL112B1NRMMP0: { CC: 112, in: "SAE J518C - 2.1/2″", out: "SAE J518C - 1.1/4″", drain: "M27 x 2", pmax: 320, regulator: "Regulator ciśnienia", holePattern: "Ø224 - Ø180 ISO 3019/2", shaft: "Ø45" },
  HKK3VL140B1NRMMP0: { CC: 140, in: "SAE J518C - 2.1/2″", out: "SAE J518C - 1.1/4″", drain: "M27 x 2", pmax: 320, regulator: "Regulator ciśnienia", holePattern: "Ø224 - Ø180 ISO 3019/2", shaft: "Ø45" },
  HKK3VL200B1NRMMP0: { CC: 200, in: "SAE J518C - 3″", out: "SAE J518C - 1.1/2″", drain: "3/4″", pmax: 320, regulator: "Regulator ciśnienia", holePattern: "224,5 x 224,5 - Ø165,1 ISO 3019/2", shaft: "Ø44,45" },
  HKK3VL045B1NRMML0: { CC: 45, in: "SAE J518C - 1.1/2″", out: "SAE J518C - 1″", drain: "M22 x 1.5", pmax: 320, regulator: "Kontroler wykrywania obciążenia", holePattern: "Ø140 - Ø100 ISO 3019/2", shaft: "Ø25" },
  HKK3VL080B1NRMML0: { CC: 80, in: "SAE J518C - 2″", out: "SAE J518C - 1″", drain: "M22 x 1.5", pmax: 320, regulator: "Kontroler wykrywania obciążenia", holePattern: "Ø180 - Ø125 ISO 3019/2", shaft: "Ø32" },
...
export const bellhousingData = [
  ...
  { title: "HKPK350062600", size: 180, holePattern: "Ø180 - Ø125", pump: "HKA10VSO71" },
  { title: "HKPK450020900", size: 225, holePattern: "Ø180 - Ø125", pump: "HKA10VSO71,HKA10VSO88,HKA10VSO100,HKK3VL080" },
  { title: "HKPK400040900", size: 200, holePattern: "Ø180 - Ø125", pump: "HKA10VSO71,HKA10VSO88,HKK3VL080" },
  { title: "HKPL550010700", size: 280, holePattern: "Ø180 - Ø125", pump: "HKA10VSO88,HKA10VSO100,HKK3VL080" },
  { title: "HKPL550081200", size: 250, holePattern: "Ø180 - Ø125", pump: "HKA10VSO71,HKA10VSO88,HKA10VSO100,HKK3VL080" },
  { title: "HKPK400053100", size: 200, holePattern: "Ø180 - Ø125", pump: "HKA10VSO100" },
  { title: "HKPL550010200", size: 250, holePattern: "Ø224 - Ø180 ISO 3019/2", pump: "HKK3VL112,HKK3VL140" },
  { title: "HKPL550010200", size: 280, holePattern: "Ø224 - Ø180 ISO 3019/2", pump: "HKK3VL112,HKK3VL140" },
  { title: "HKPK660020500", size: 315, holePattern: "Ø224 - Ø180 ISO 3019/2", pump: "HKK3VL140" },
  { title: "HKPK660020400", size: 315, holePattern: "224,5 x 224,5 - Ø165,1 ISO 3019/2", pump: "HKK3VL200" },
...
const singleConnectionPlate = [
  { title: "HKES3B38X2F", cetop: 3, pressure: 210, threadP: "G3/8″ -19", threadT: "G3/8″ -19", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: true },
  { title: "HKES3B38X3F", cetop: 3, pressure: 350, threadP: "G3/8″ -19", threadT: "G3/8″ -19", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: true },
  { title: "HKES5B34PLX2F", cetop: 5, pressure: 120, threadP: "G3/4″ -14", threadT: "G3/4″ -14", threadA: "G3/4″ -14", threadB: "G3/4″ -14", DBV: true },
  { title: "HKES5B34PLX3F", cetop: 5, pressure: 270, threadP: "G3/4″ -14", threadT: "G3/4″ -14", threadA: "G3/4″ -14", threadB: "G3/4″ -14", DBV: true },
  { title: "HKEM103138X2F", cetop: 3, pressure: 210, threadP: "G1/2″ -14", threadT: "G1/2″ -14", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: true },
  { title: "HKEM103138X3F", cetop: 3, pressure: 350, threadP: "G1/2″ -14", threadT: "G1/2″ -14", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: true },
  { title: "HKEM105134X2F", cetop: 5, pressure: 120, threadP: "G3/4″ -14", threadT: "G3/4″ -14", threadA: "G3/4″ -14", threadB: "G3/4″ -14", DBV: true },
  { title: "HKEM105134X3F", cetop: 5, pressure: 270, threadP: "G3/4″ -14", threadT: "G3/4″ -14", threadA: "G3/4″ -14", threadB: "G3/4″ -14", DBV: true },
  { title: "K-DR2-06/11-AL", cetop: 3, pressure: 210, threadP: "G1/2″ -14", threadT: "G1/2″ -14", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: true, addition: { SR1: { title: "K-SR1A-B2/H25S" } } },
  { title: "HKBA201HF", cetop: 3, pressure: 350, threadP: "G3/8″ -19", threadT: "G3/8″ -19", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: false },
  { title: "HKBA202HF", cetop: 3, pressure: 350, threadP: "G3/8″ -19", threadT: "G3/8″ -19", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: false },
  { title: "HKBA204HF", cetop: 3, pressure: 350, threadP: "G3/8″ -19", threadT: "G3/8″ -19", threadA: "G3/8″ -19", threadB: "G3/8″ -19", DBV: false },
];
...
const gaugeBottom = [
  { title: "GMM63-40", pmax: 40, thread: "G1/4″ -19" },
  { title: "GMM63-60", pmax: 60, thread: "G1/4″ -19" },
  { title: "GMM63-100", pmax: 100, thread: "G1/4″ -19" },
  { title: "GMM63-160", pmax: 160, thread: "G1/4″ -19" },
  { title: "GMM63-250", pmax: 250, thread: "G1/4″ -19" },
  { title: "GMM63-400", pmax: 400, thread: "G1/4″ -19" },
  { title: "GMM63-600", pmax: 600, thread: "G1/4″ -19" },
  { title: "GMM63-1000", pmax: 1000, thread: "G1/4″ -19" },
];
...
export const xvrnw = [
  { title: "XVRNW08HL1/8ED", pipe: "L10-1.5", thread: "G1/8″ -28" },
  { title: "XVRNW08HLED", pipe: "L10-1.5", thread: "G1/4″ -19" },
  { title: "XVRNW08HL1/2ED", pipe: "L10-1.5", thread: "G1/2″ -14" },
  { title: "XVRNW08HL3/8ED", pipe: "L10-1.5", thread: "G3/8″ -19" },

  { title: "XVRNW10HL1/8", pipe: "L12-1.5", thread: "G1/8″ -28" },
  { title: "XVRNW10HL1/4ED", pipe: "L12-1.5", thread: "G1/4″ -19" },
  { title: "XVRNW10HL1/2ED", pipe: "L12-1.5", thread: "G1/2″ -14" },
  { title: "XVRNW10HLED", pipe: "L12-1.5", thread: "G3/8″ -19" },
  { title: "XVRNW10HL3/4ED", pipe: "L12-1.5", thread: "G3/4″ -14" },

  { title: "XVRNW13HL1/4", pipe: "L15-1.5", thread: "G1/4″ -19" },
  { title: "XVRNW13HL3/8ED", pipe: "L15-1.5", thread: "G3/8″ -19" },
  { title: "XVRNW13HLED", pipe: "L15-1.5", thread: "G1/2″ -14" },
  { title: "XVRNW13HL3/4ED", pipe: "L15-1.5", thread: "G3/4″ -14" },
  { title: "XVRNW13HL1", pipe: "L15-1.5", thread: "G1″ -11" },

  { title: "XVRNW16HL3/8ED", pipe: "L18-2", thread: "G3/8″ -19" },
  { title: "XVRNW16HLED", pipe: "L18-2", thread: "G1/2″ -14" },
  { title: "XVRNW16HL3/4ED", pipe: "L18-2", thread: "G3/4″ -14" },
  { title: "XVRNW16HL1", pipe: "L18-2", thread: "G1″ -11" },

  { title: "XVRNW20HL1/2ED", pipe: "L22-2", thread: "G1/2″ -14" },
  { title: "XVRNW20HLED", pipe: "L22-2", thread: "G3/4″ -14" },
  { title: "XVRNW20HL1ED", pipe: "L22-2", thread: "G1″ -11" },

  { title: "XVRNW25HL1/2", pipe: "L28-2.5", thread: "G1/2″ -14" },
  { title: "XVRNW25HL3/4ED", pipe: "L28-2.5", thread: "G3/4″ -14" },
  { title: "XVRNW25HLED", pipe: "L28-2.5", thread: "G1″ -11" },
  { title: "XVRNW25HL11/4ED", pipe: "L28-2.5", thread: "G1.1/4″ -11" },

  { title: "XVRNW32HL3/4", pipe: "L35-3", thread: "G3/4″ -14" },
  { title: "XVRNW32HL1ED", pipe: "L35-3", thread: "G1″ -11" },
  { title: "XVRNW32HLED", pipe: "L35-3", thread: "G1.1/4″ -11" },
  { title: "XVRNW32HL11/2ED", pipe: "L35-3", thread: "G1.1/2″ -11" },

  { title: "XVRNW40HL11/4ED", pipe: "L42-3", thread: "G1.1./4 -11″" },
  { title: "XVRNW40HLED", pipe: "L42-3", thread: "G1.1/2″ -11" },

  { title: "XVRNW06HS1/4ED", pipe: "S10-2", thread: "G1/4″ -19" },
  { title: "XVRNW06HSED", pipe: "S10-2", thread: "G3/8″ -19" },
  { title: "XVRNW06HS1/2ED", pipe: "S10-2", thread: "G1/2″ -14" },

  { title: "XVRNW08HS1/4ED", pipe: "S12-2.5", thread: "G1/4″ -19" },
  { title: "XVRNW08HSED", pipe: "S12-2.5", thread: "G3/8″ -19" },
  { title: "XVRNW08HS1/2ED", pipe: "S12-2.5", thread: "G1/2″ -14" },
  { title: "XVRNW08HS3/4", pipe: "S12-2.5", thread: "G3/4″ -14" },

  { title: "XVRNW10HS3/8ED", pipe: "S14-3.5", thread: "G3/8″ -19" },
  { title: "XVRNW10HSED", pipe: "S14-3.5", thread: "G1/2″ -14" },
  { title: "XVRNW10HS3/4ED", pipe: "S14-3.5", thread: "G3/4″ -14" },

  { title: "XVRNW13HS1/4", pipe: "S16-3.5", thread: "G1/4″ -19" },
  { title: "XVRNW13HS3/8ED", pipe: "S16-3.5", thread: "G3/8″ -19" },
  { title: "XVRNW13HSED", pipe: "S16-3.5", thread: "G1/2″ -14" },
  { title: "XVRNW13HS3/4ED", pipe: "S16-3.5", thread: "G3/4″ -14" },
  { title: "XVRNW13HS1ED", pipe: "S16-3.5", thread: "G1″ -11" },

  { title: "XVRNW16HS1/2ED", pipe: "S20-4", thread: "G1/2″ -14" },
  { title: "XVRNW16HSED", pipe: "S20-4", thread: "G3/4″ -14" },
  { title: "XVRNW16HS1ED", pipe: "S20-4", thread: "G1″ -11" },

  { title: "XVRNW20HS1/2ED", pipe: "S25-4", thread: "G1/2″ -14" },
  { title: "XVRNW20HS3/4ED", pipe: "S25-4", thread: "G3/4″ -14" },
  { title: "XVRNW20HSED", pipe: "S25-4", thread: "G1″ -11" },
  { title: "XVRNW20HS11/4", pipe: "S25-4", thread: "G1.1/4″ -11" },

  { title: "XVRNW25HS3/4", pipe: "S30-4", thread: "G3/4″ -14" },
  { title: "XVRNW25HS1ED", pipe: "S30-4", thread: "G1″ -11" },
  { title: "XVRNW25HSED", pipe: "S30-4", thread: "G1.1/4″ -11" },
  { title: "XVRNW25HS11/2", pipe: "S30-4", thread: "G1.1/2″ -11" },

  { title: "XVRNW32HS1", pipe: "S38-4", thread: "G1″ -11" },
